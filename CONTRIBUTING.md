# Contributing to sachncs

Thanks for your interest in sachncs. This document explains how to set up
the project locally, run the test suite, and submit a pull request.

## Reporting issues

Open an issue at
[`sachncs/sachncs/issues`](https://github.com/sachncs/sachncs/issues)
